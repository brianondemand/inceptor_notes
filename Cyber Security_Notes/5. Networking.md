...
![Router and Switch](https://www.w3schools.com/cybersecurity/img_router_and_switch.png)
...
![IP Header](https://www.w3schools.com/cybersecurity/img_ip-header.png)
...
An excellent tool to perform text analysis and run operations such as URL Decoding is CyberChef. You can try it out in your browser here: [https://gchq.github.io/CyberChef/](https://gchq.github.io/CyberChef/)
...
The encryption used to be SSL ("Secure Sockets Layer"), but has since been deprecated. Instead TLS ("Transport Layer Security") is typically used to enforce encryption.78nmmmmmmmmmmmmmmmmmmmmnmnm8